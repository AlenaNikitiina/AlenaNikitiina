...
## About me
Меня зовут Алёна и я начинающий frontend-разработчик. Недавно я закончила обучение, где изучала: HTML-вёрстку, CSS, JS, React.js и основы бэкенда на Node.js. Мне всегда было интересно пожить в другой стране и поэтому я переехала на Кипр. До этого я работала врачом анестезиологом-реаниматологом, но параллельно пробовала профессии связанные с дизайном и программированием. Теперь полностью посвящаю себя web разработке. В данный момент завершила один коммерческий сайт и приступаю к следующему. Могу и вам создать! :)
